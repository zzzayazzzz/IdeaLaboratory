...
public abstract class TechListFragment extends Fragment {
    ...
    private static final String TAG = "TechListFragment";
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_all_tech, container, false);
        ...
        mRecycler = (RecyclerView) rootView.findViewById(R.id.tech_list);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        Query techQuery = getQuery(mDatabase);
